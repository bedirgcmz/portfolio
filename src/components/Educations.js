            ...
            myEducations.map((edu, index) => (
                <div key={index} class="accordion-item">
                    <div className='edu-name-container'>
                        ...
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target={`#colleps${edu.id}`} aria-expanded="false" aria-controls={`colleps${edu.id}`}>
                        <i class={edu.icon}></i>{edu.edu_name}
                    ...
                    <div id={`colleps${edu.id}`} class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <h6 className='edu-company-name'><i class="fa-solid fa-city pe-3"></i>{edu.company}</h6>
                            {edu.info}
                        </div>                        
                    </div>
                </div>
