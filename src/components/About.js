    ...
    <div id="about" className="about-margin-top">
      ...
      <div className="about-container row">
        ...
        <div className="about-me-text-container col-12 col-sm-12 col-md-6">
          <h1 className="my-fullname text-center">
            Welcome, I'm <span className="d-block">Bedir Gocmez</span>{" "}
          </h1>
          <p className="about-me-text text-justify">
            I am an ambitious Developer with a passion for software and
            technology. I have been improving myself in the field of informatics
            for 2 years. I continued learning on many platforms and learned
            different programming languages. I also completed a course called
            "Full Stack Web Development". Now I have started the "Frontend / App
            Developer" training at Högskola. A few years ago, I developed
            web-based applications with my newly acquired skills and I am able
            to improve myself in front-end and back-end disciplines. I am very
            keen to learn new technologies and especially artificial
            intelligence. I think I am very flexible and agile in team work.
          </p>
        </div>
