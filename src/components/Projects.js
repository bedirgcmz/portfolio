            ...
            <div className="top-cards row">
              ...
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className="my-card">
                  ...
                  <div className="card-right-content">
                    <h6 className="project-title m-0">
                      {projectData[1].project_name}
                    </h6>
                    <p className="project-info">{projectData[1].info}</p>
                    <div className="d-flex justify-content-between">
                      <a href={projectData[1].link} className="see-demo">
                        Go Project
                      </a>
                      <a
            ...
            <div className="bottom-cards row">
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className="my-card">
                  ...
                  <div className="card-right-content">
                    <h6 className="project-title m-0">
                      {projectData[2].project_name}
                    </h6>
                    <p className="project-info">{projectData[2].info}</p>
                    <div className="d-flex justify-content-between">
                      <a href={projectData[2].link} className="see-demo">
                        See demo
                      </a>
                      <a
              ...
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className="my-card">
                  ...
                  <div className="card-right-content">
                    <h6 className="project-title m-0">
                      {projectData[3].project_name}
                    </h6>
                    <p className="project-info">{projectData[3].info}</p>
                    <div className="d-flex justify-content-between">
                      <a href={projectData[3].link} className="see-demo">
                        Go Project
                      </a>
                      <a href={projectData[3].link} className="go-github">
                        Go Github
                      </a>
                    </div>
                  </div>
            ...
            <div className="top-cards row">
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className="my-card">
                  ...
                  <div className="card-right-content">
                    <h6 className="project-title m-0">
                      {projectData[4].project_name}
                    </h6>
                    <p className="project-info">{projectData[4].info}</p>
                    <div className="d-flex justify-content-between">
                      <a href={projectData[4].link} className="see-demo">
                        See demo
                      </a>
                      <a
              ...
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className="my-card">
                  ...
                  <div className="card-right-content">
                    <h6 className="project-title m-0">
                      {projectData[5].project_name}
                    </h6>
                    <p className="project-info">{projectData[5].info}</p>
                    <div className="d-flex justify-content-between">
                      <a href={projectData[5].link} className="see-demo">
                        Go Project
                      </a>
                      <a
            ...
            <div className="bottom-cards row">
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className="my-card">
                  ...
                  <div className="card-right-content">
                    <h6 className="project-title m-0">
                      {projectData[6].project_name}
                    </h6>
                    <p className="project-info">{projectData[6].info}</p>
                    <div className="d-flex justify-content-between">
                      <a href={projectData[6].link} className="see-demo">
                        See demo
                      </a>
                      <a
              ...
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className="my-card">
                  ...
                  <div className="card-right-content">
                    <h6 className="project-title m-0">
                      {projectData[7].project_name}
                    </h6>
                    <p className="project-info">{projectData[7].info}</p>
                    <div className="d-flex justify-content-between">
                      <a href={projectData[7].link} className="see-demo">
                        Go Project
                      </a>
                      <a href={projectData[7].link} className="go-github">
                        Go Github
                      </a>
                    </div>
                  </div>
            ...
            <div className="top-cards row">
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className="my-card">
                  ...
                  <div className="card-right-content">
                    <h6 className="project-title m-0">
                      {projectData[8].project_name}
                    </h6>
                    <p className="project-info">{projectData[8].info}</p>
                    <div className="d-flex justify-content-between">
                      <a href={projectData[8].link} className="see-demo">
                        See demo
                      </a>
                      <a
              ...
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className="my-card">
                  ...
                  <div className="card-right-content">
                    <h6 className="project-title m-0">
                      {projectData[9].project_name}
                    </h6>
                    <p className="project-info">{projectData[9].info}</p>
                    <div className="d-flex justify-content-between">
                      <a href={projectData[9].link} className="see-demo">
                        Go Project
                      </a>
                      <a
            ...
            <div className="bottom-cards row">
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className="my-card">
                  ...
                  <div className="card-right-content">
                    <h6 className="project-title m-0">
                      {projectData[10].project_name}
                    </h6>
                    <p className="project-info">{projectData[10].info}</p>
                    <div className="d-flex justify-content-between">
                      <a href={projectData[10].link} className="see-demo">
                        See demo
                      </a>
                      <a
              ...
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className="my-card">
                  ...
                  <div className="card-right-content">
                    <h6 className="project-title m-0">
                      {projectData[11].project_name}
                    </h6>
                    <p className="project-info">{projectData[11].info}</p>
                    <div className="d-flex justify-content-between">
                      <a href={projectData[11].link} className="see-demo">
                        Go Project
                      </a>
                      <a href={projectData[11].link} className="go-github">
                        Go Github
                      </a>
                    </div>
                  </div>
            ...
            <div className="top-cards row">
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className="my-card">
                  ...
                  <div className="card-right-content">
                    <h6 className="project-title m-0">
                      {projectData[12].project_name}
                    </h6>
                    <p className="project-info">{projectData[12].info}</p>
                    <div className="d-flex justify-content-between">
                      <a href={projectData[12].link} className="see-demo">
                        See demo
                      </a>
                      <a
              ...
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className="my-card">
                  ...
                  <div className="card-right-content">
                    <h6 className="project-title m-0">
                      {projectData[13].project_name}
                    </h6>
                    <p className="project-info">{projectData[13].info}</p>
                    <div className="d-flex justify-content-between">
                      <a href={projectData[13].link} className="see-demo">
                        Go Project
                      </a>
                      <a
